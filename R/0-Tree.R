...
Tree= function(){
  list(
    ...
    Palive_Branch_Tree    = Paliv_dis(40,0.4,0.05,5),  # Branch living tissue (fraction). Not used (replaced by Palive_Stem_Tree).
    Palive_Stem_Tree      = Paliv_dis(40,0.3,0.05,5),  # Computation of living tissue at each age (do not modify)
    Palive_CR_Tree        = 0.21,                      # Coarse roots living tissue (fraction)
    Palive_Leaf_Tree      = 1,                         # Leaf living tissue (fraction)
    Palive_FRoot_Tree     = 1,                         # Fine root living tissue (fraction)
