...
coffee= function(){
  list(
    ...
    Demand_Leaf_Max   = 1.8,        # Leaf carbon demand (gC m-2 d-1)
    LAI_max           = 5,          # Max measured LAI to compute leaf demand. Should be ~1.5*higher than measured.
    ...
    lambdaSCR         = 0.025,      # Allocation coefficient to stump and coarse roots
