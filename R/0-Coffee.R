...
coffee= function(){
  list(
    ...
    kres              = 0.40,       # Maximum carbon proportion extracted from reserves mass per day
    ...
    Tffb              = 3500,       # Time of first floral buds (Rodriguez et al., 2001).
    ...
    RainForBudBreak   = 50,         # Amount of cumulative rainfall to break bud dormancy (mm). Source: 20 mm Zacharias et al. (2008)
    ...
    lambdaRsWood      = 0.11,       # Allocation coefficient to resprout wood
    lambdaSCR         = 0.08,       # Allocation coefficient to stump and coarse roots at age 0.
    lambdaLeaf_remain = 0.90,       # Allocation coefficient to allocate the remaining carbon to leaves and fine roots
    lambdaFRoot_remain= 0.10,       # Idem, remain carbon: (1-lambdaRsWood-lambdaSCR-Fruit_Allocation)
    ...
    M_RateFRootprun   = 0.005,      # Fine root percentage that die at pruning
