...
coffee= function(){
  list(
    ...
    lambda_RsWood     = 0.14,       # Allocation coefficient to resprout wood
    ...
    lambda_FRoot_remain= 0.15,      # Idem, remain carbon: (1-lambda_RsWood-lambda_SCR-Fruit_Allocation)
    ...
    epsilon_RsWood    = 1.20,       # Resprout wood growth respiration coefficient (g g-1). Source: Dufrêne et al. (2005)
    ...
    NC_RsWood         = 0.0041,     # Resprout wood nitrogen content (gN gDM-1). Source: Ghini et al. (2015), 28.2 to 30.9 g kg−1 DW
    ...
    Q10_RsWood        = 2.4,        # Resprout wood Q10 (-)
