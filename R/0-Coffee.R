...
coffee= function(){
  list(
    ...
    k_Dif             = 0.39,       # Light extinction coefficient for diffuse light (-), computed from MAESPA
    k_Dir             = 0.34,       # Light extinction coefficient for direct light (-), computed from MAESPA
