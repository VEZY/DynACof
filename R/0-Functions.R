...
Import_Parameters= function(path= "1-Input/Default",
                            Names= list(
                                Site="1-Site.R",
                                Soil="3-Soil.R",
                                Coffee="4-Coffee.R",
    ...
    for(x in Names){
        if(is.character(x)){
            ...
            Parameters= c(Parameters,Parameters_f())
        }
    }

    if(is.null(Names$Tree)){Parameters$Tree_Species= "No_Shade"}
    return(Parameters)
}
...
Convert.Var= function(Var, Conv,KHRS=48){
    ...
    CONV.mmol.to.mm = SPERHR * 1E-06 * 18 # From MAESPA, mmol.m-2.s-1 to mm
    CONV_mm.to.W= (2.45*10^6)/SPERHR
    CONV_W.to.umol= 4.57
    if(Conv=="mmol.m-2.s-1_To_mm.semihour"){Var= Var*CONV.mmol.to.mm}
    if(Conv=="mmol.m-2.s-1_To_W.m-2"){Var= Var*CONV.mmol.to.mm*CONV_mm.to.W}
...
Init_Table_Day= function(S){
    ...
    S$Table_Day$CM_RE=  0
    S$Table_Day$Rm= 0
    S$Table_Day$CM_StumpCoarseRoot= 0
    S$Table_Day$PDem_FruitYear= 0
    S$Table_Day$Pdem_Fruit_overm= 0
    S$Table_Day$CM_Fruit= 0
    S$Table_Day$Sucrose_Mass= 0
    S$Table_Day$CM_Fruit_Pot= 0
    S$Table_Day$Sucrose_Concentr= 0
    S$Table_Day$Harvest_Maturity= 0
    S$Table_Day$CM_Leaf= 1
    S$Table_Day$CM_FineRoot= 0
    S$Table_Day$CM_RsWood= 0
    S$Table_Day$DM_Leaf=
        S$Table_Day$DM_FineRoot=
        S$Table_Day$DM_RsWood=
        S$Table_Day$DM_Fruit=
        S$Table_Day$DM_StumpCoarseRoot=
        S$Table_Day$DM_Fruit_Cohort=
        S$Table_Day$DM_RE= 0
    S$Table_Day$Mact_StumpCoarseRoot=
        S$Table_Day$Mnat_StumpCoarseRoot= 0
    S$Table_Day$Mprun_RsWood= 0
    S$Table_Day$DegreeDays_Tcan=
        S$Table_Day$Budinit=
        S$Table_Day$DormantBuds=
        S$Table_Day$BudBreak=
        S$Table_Day$Bud_available=
        S$Table_Day$BudBreak_cohort=
        S$Table_Day$PactRc_Fruit_Cohort=
    ...
    S$Table_Day$lue=
        ...
        S$Table_Day$Rm_Leaf=
        S$Table_Day$PDem_FineRoot=
        S$Table_Day$Poff_FineRoot=
        S$Table_Day$PactRc_FineRoot=
        S$Table_Day$NPP_FineRoot=
        S$Table_Day$Rc_FineRoot=
        S$Table_Day$Mnat_FineRoot=
        S$Table_Day$Mprun_FineRoot=
        S$Table_Day$Mact_FineRoot=
        S$Table_Day$Rm_FineRoot=
        S$Table_Day$Rc=
        S$Table_Day$Ra=
        S$Table_Day$NPPtot=
    ...
    S$Table_Day$ThSt_mmd=
        S$Table_Day$IntercRevapor_mmd=
        S$Table_Day$ExcessRunoff_mmd=
        S$Table_Day$SuperficialRunoff1_mmd=
        S$Table_Day$TotSuperficialRunoff_mmd=
        S$Table_Day$InfilCapa_mmd=
        S$Table_Day$Infiltration_mmd=
        S$Table_Day$Drain1.mm=
        S$Table_Day$Drain2.mm=
        S$Table_Day$Drain3.mm=
        S$Table_Day$EW1.mm=
        S$Table_Day$REW1.mm=
        S$Table_Day$EW2.mm=
        S$Table_Day$REW2.mm=
        S$Table_Day$EW3.mm=
        S$Table_Day$REW3.mm=
        S$Table_Day$EWtot.mm=
        S$Table_Day$REWtot.mm=
        S$Table_Day$Coeff.partitionHLE.understorey=
        S$Table_Day$Eu_mmd=
        S$Table_Day$RootWaterExtract3_mmd=
        S$Table_Day$LE_Plot_MJm2d=
        S$Table_Day$LESoil_MJm2d=
        S$Table_Day$HSoil_MJm2d=
        S$Table_Day$QSoil_MJm2d=
        S$Table_Day$RnSoil_MJm2d=
        S$Table_Day$LE_Tree_MJm2d=
        S$Table_Day$H_tot_MJm2d=
        S$Table_Day$LE_tot_MJm2d=
        S$Table_Day$Tcan_MAESPAminusTa_degC=
        S$Table_Day$Tcan_mod_CoffeeminusTa_degC=
        S$Table_Day$Tcan_mod_Coffee_degC=
        S$Table_Day$APAR_Dif=
        S$Table_Day$APAR=
        S$Table_Day$PAR_Soil=
        S$Table_Day$Tcan_MAESPA_Coffee_degC=
        S$Table_Day$SoilWaterPot=
        S$Table_Day$LeafWaterPotCof=
        S$Table_Day$Rnu_MJm2d_OLD=
        S$Table_Day$AEu_MJm2d=
        S$Table_Day$IntercMax.mm=
        S$Table_Day$T_Cof_mmd=
        S$Table_Day$LeafWaterPot=
        S$Table_Day$T_Plot_mmd=
        S$Table_Day$RootWaterExtract1_mmd=
        S$Table_Day$RootWaterExtract2_mmd=
        S$Table_Day$ETR_Plot_mmd=
        S$Table_Day$SWDtot.mm=
        S$Table_Day$H_Coffee_MJm2d=
        S$Table_Day$Rncoffee_MJm2d=
        S$Table_Day$LE_Coffee_MJm2d=0

    S$Table_Day$W1.mm=290#670 #assumed to be at full level at the time of planting and 1rst of January
    S$Table_Day$W2.mm=66#205
    S$Table_Day$W3.mm=69#850
    S$Table_Day$Wtot.mm= S$Table_Day$W1.mm+S$Table_Day$W2.mm+S$Table_Day$W3.mm

    S$Table_Day$CanopyHumect.mm=0 #assume to be dry foliage
    S$Table_Day$WSurfaceRes_mm=0 #assume to half of max
...
No_Shade.init= function(S){
    ...
    # needed in-code (e.g. Tree Height for metamodels):
    # APAR_Tree, LAI_Tree, T_Tree_mmd, RnTree_MJm2d, H_Tree_MJm2d,
    # LE_Tree_MJm2d (sum of transpiration + leaf evap), DBH_Tree_cm (for LUE),
    # CrownProj_Tree_ind, DBH_Tree_cm, CrownH_Tree_m
    S$Table_Day$LAI_Tree=
        S$Table_Day$DBH_Tree_cm=
        S$Table_Day$CrownH_Tree_m=
        S$Table_Day$CrownProj_Tree_ind=
        S$Table_Day$APAR_Tree=
        S$Table_Day$T_Tree_mmd=
        S$Table_Day$RnTree_MJm2d=
        S$Table_Day$H_Tree_MJm2d=
        S$Table_Day$LE_Tree_MJm2d=
        0
}
...
Tree.init= function(S){
    ...
    S$Table_Day$CM_FineRoot_Tree= 0.01
    ...
    S$Table_Day$DBH_Tree_m_V=
        S$Table_Day$Trunk_H_Tree=
        S$Table_Day$Crown_H_Tree_m=
        S$Table_Day$LA_Tree=
        0
    ...
    S$Table_Day$K_Dif_Tree=
        ...
        S$Table_Day$Rm_FineRoot_Tree=
        S$Table_Day$OfferFunction_Tree=
        S$Table_Day$PactRc_Stem_Tree=
        S$Table_Day$NPP_Stem_Tree=
        S$Table_Day$Rc_Stem_Tree=
        S$Table_Day$PactRc_CoarseRoot_Tree=
        S$Table_Day$NPP_CoarseRoot_Tree=
        S$Table_Day$Rc_CoarseRoot_Tree=
        S$Table_Day$PactRc_Branch_Tree=
        S$Table_Day$NPP_Branch_Tree=
        S$Table_Day$Rc_Branch_Tree=
        S$Table_Day$Mact_Branch_Tree=
        S$Table_Day$PactRc_Leaf_Tree=
        S$Table_Day$NPP_Leaf_Tree=
        S$Table_Day$Rc_Leaf_Tree=
        S$Table_Day$Mact_Leaf_Tree=
        S$Table_Day$PactRc_FineRoot_Tree=
        S$Table_Day$NPP_FineRoot_Tree=
        S$Table_Day$Rc_FineRoot_Tree=
        S$Table_Day$Mact_FineRoot_Tree=
        S$Table_Day$PactRc_Reserves_Tree=
        S$Table_Day$Rc_Reserves_Tree=
        S$Table_Day$Rc_Tree=
        S$Table_Day$Ra_Tree=
        S$Table_Day$DeltaCM__Tree=
        S$Table_Day$sumL_Tree=
        S$Table_Day$NPPtot_Tree=
        S$Table_Day$Cbalance_Tree=
        S$Table_Day$H_Tree_m=
        S$Table_Day$Stem_Volume_FGM_m3.ha_Tree=
        S$Table_Day$StemDryMass_FGM_tDM_ha=
        S$Table_Day$CrownRad_Tree_m=
        S$Table_Day$LAI_FGM_Tree=
        S$Table_Day$DM_Leaf_FGM_gDM_Tree=
        S$Table_Day$DMStem_FGM_Tree=
        S$Table_Day$NPP_Stem_FGM_Tree=
        S$Table_Day$NPP_Leaf_FGM_Tree=
        S$Table_Day$NPP_Reserves_Tree=
        S$Table_Day$Consumption_RE_Tree=
        0

    # Thinning:
    S$Table_Day$StockingTree_tree_m2= S$Parameters$StockingTree_treeha1/10000
    ...
    S$Table_Day$MThinning_FineRoot_Tree= 0


    # Energy budget :
    S$Table_Day$RnTree_MJm2d=
        S$Table_Day$H_Tree_MJm2d=
        S$Table_Day$Rn_tot_MJm2d=
        S$Table_Day$RnTree_MJm2d=
        0
}
...
Shade.Tree= function(S,i){
    ...
    # LE_Tree_MJm2d (sum of transpiration + leaf evap)
    # And via allometries: DBH_Tree_cm (for LUE), CrownProj_Tree_ind, CrownH_Tree_m
    ...
    S$Table_Day$Rm_FineRoot_Tree[i]=
        S$Parameters$PaliveFineRoot_Tree*
        S$Table_Day$DM_FineRoot_Tree[i-S$Zero_then_One[i]]*
        S$Parameters$MRN*S$Parameters$NContentFineRoot_Tree*
        S$Parameters$Q10FineRoot_Tree^(
            (S$Met_c$Tair[i]-S$Parameters$TMR)/10)
    ...
    S$Table_Day$OfferFunction_Tree[i]=
    ...
    S$Table_Day$PactRc_Stem_Tree[i]=
        S$Parameters$lambdaStem_Tree*S$Table_Day$OfferFunction_Tree[i]
    #NPP = Offer * growth cost coefficient:
    S$Table_Day$NPP_Stem_Tree[i]=
        S$Parameters$epsilonStem_Tree*S$Table_Day$PactRc_Stem_Tree[i]
    # Growth respiration = Offer * (1-growth cost coefficient):
    S$Table_Day$Rc_Stem_Tree[i]=
        (1-S$Parameters$epsilonStem_Tree)*S$Table_Day$PactRc_Stem_Tree[i]
    ...
    #### Coarse Roots ####
    # Offer:
    S$Table_Day$PactRc_CoarseRoot_Tree[i]=
        S$Parameters$lambdaCoarseRoot_Tree*S$Table_Day$OfferFunction_Tree[i]
    #NPP
    ...
    S$Table_Day$PactRc_Branch_Tree[i]=
        S$Parameters$lambdaBranchWood_Tree*S$Table_Day$OfferFunction_Tree[i]
    #NPP
    S$Table_Day$NPP_Branch_Tree[i]=
        S$Parameters$epsilonBranch_Tree*S$Table_Day$PactRc_Branch_Tree[i]
    # Growth respiration:
    S$Table_Day$Rc_Branch_Tree[i]=
        (1-S$Parameters$epsilonBranch_Tree)*S$Table_Day$PactRc_Branch_Tree[i]
    # Natural mortality:
    ...
    #### Leaves ####
    # Offer:
    S$Table_Day$PactRc_Leaf_Tree[i]=
        S$Parameters$lambdaLeaf_Tree*S$Table_Day$OfferFunction_Tree[i]
    #NPP
    S$Table_Day$NPP_Leaf_Tree[i]=
        S$Parameters$epsilonLeaf_Tree*S$Table_Day$PactRc_Leaf_Tree[i]
    # Growth respiration:
    S$Table_Day$Rc_Leaf_Tree[i]=
        (1-S$Parameters$epsilonLeaf_Tree)*S$Table_Day$PactRc_Leaf_Tree[i]
    ...
    #### Fine roots ####
    # Offer
    S$Table_Day$PactRc_FineRoot_Tree[i]=
        S$Parameters$lambdaFineRoot_Tree*S$Table_Day$OfferFunction_Tree[i]
    # NPP
    S$Table_Day$NPP_FineRoot_Tree[i]=
        S$Parameters$epsilonFineRoot_Tree*S$Table_Day$PactRc_FineRoot_Tree[i]
    # Growth respiration
    S$Table_Day$Rc_FineRoot_Tree[i]=
        (1-S$Parameters$epsilonFineRoot_Tree)*S$Table_Day$PactRc_FineRoot_Tree[i]
    # Natural mortality
    S$Table_Day$Mact_FineRoot_Tree[i]=
        S$Table_Day$CM_FineRoot_Tree[i-S$Zero_then_One[i]]/S$Parameters$lifespanFineRoot_Tree


    #### Reserves ####

    # Offer
    S$Table_Day$PactRc_Reserves_Tree[i]=
        S$Parameters$lambdaReserves_Tree*S$Table_Day$OfferFunction_Tree[i]
    # Allocation
    S$Table_Day$NPP_Reserves_Tree[i]=
        S$Parameters$epsilonReserves_Tree*S$Table_Day$PactRc_Reserves_Tree[i]
    # Cost of allocating to reserves
    S$Table_Day$Rc_Reserves_Tree[i]=
        (1-S$Parameters$epsilonReserves_Tree)*S$Table_Day$PactRc_Reserves_Tree[i]
    ...
    if(S$Table_Day$Plot_Age[i]%in%S$Parameters$Pruning_Age_Tree&&S$Met_c$DOY[i]%in%S$Parameters$date_pruning_Tree){
        ...
        # S$Table_Day$Mprun_FineRoot_Tree[i]= (S$Table_Day$Mprun_Leaf_Tree[i]*0.5)
        S$Table_Day$Mprun_FineRoot_Tree[i]=
            S$Table_Day$CM_FineRoot_Tree[i-S$Zero_then_One[i]]*S$Parameters$pruningIntensity_Tree
        S$Table_Day$Mact_FineRoot_Tree[i]=
            min(S$Table_Day$Mact_FineRoot_Tree[i]+S$Table_Day$Mprun_FineRoot_Tree[i],
                S$Table_Day$CM_FineRoot_Tree[i-S$Zero_then_One[i]])
    }
    ...
    if(S$Table_Day$TimetoThin_Tree[i]==1){
        ...
        S$Table_Day$StockingTree_tree_m2[i:nrow(S$Table_Day)]=
            S$Table_Day$StockingTree_tree_m2[i-1]*(1-S$Parameters$RateThinning_Tree)
        ...
        S$Table_Day$MThinning_FineRoot_Tree[i]=
            S$Table_Day$CM_FineRoot_Tree[i-S$Zero_then_One[i]]*S$Parameters$RateThinning_Tree
    }
    ...
    S$Table_Day$CM_FineRoot_Tree[i]=
        S$Table_Day$CM_FineRoot_Tree[i-S$Zero_then_One[i]]+
        S$Table_Day$NPP_FineRoot_Tree[i]-S$Table_Day$Mact_FineRoot_Tree[i]-
        S$Table_Day$MThinning_FineRoot_Tree[i]
...
##########################################
    ...
    S$Table_Day$DM_FineRoot_Tree[i]=
        S$Table_Day$CM_FineRoot_Tree[i]/S$Parameters$CContent_wood_Tree
    ...
    S$Table_Day$Rc_Tree[i]=
        ...
        S$Table_Day$Rc_FineRoot_Tree[i]+S$Table_Day$Rc_Reserves_Tree[i]

    S$Table_Day$Ra_Tree[i]=
        S$Table_Day$Rm_Tree[i]+S$Table_Day$Rc_Tree[i]

    # NPP=DeltaCM_+sumL+Exports
    S$Table_Day$DeltaCM__Tree[i]=
        (S$Table_Day$NPP_Leaf_Tree[i]-S$Table_Day$Mact_Leaf_Tree[i])-
        S$Table_Day$MThinning_Leaf_Tree[i]+
        (S$Table_Day$NPP_Branch_Tree[i]-S$Table_Day$Mact_Branch_Tree[i])-
        S$Table_Day$MThinning_Branch_Tree[i]+
        (S$Table_Day$NPP_CoarseRoot_Tree[i]-S$Table_Day$Mact_CoarseRoot_Tree[i])-
        S$Table_Day$MThinning_CoarseRoot_Tree[i]+
        (S$Table_Day$NPP_Stem_Tree[i]-S$Table_Day$Mact_Stem_Tree[i])-
        S$Table_Day$MThinning_Stem_Tree[i]+
        (S$Table_Day$NPP_FineRoot_Tree[i]-S$Table_Day$Mact_FineRoot_Tree[i])-
        S$Table_Day$MThinning_FineRoot_Tree[i]+S$Table_Day$NPP_Reserves_Tree[i]


    S$Table_Day$sumL_Tree[i]=
        S$Table_Day$Mact_Leaf_Tree[i]+S$Table_Day$Mact_Branch_Tree[i]+
        S$Table_Day$Mact_CoarseRoot_Tree[i]+S$Table_Day$Mact_Stem_Tree[i]+
        S$Table_Day$Mact_FineRoot_Tree[i]
        S$Table_Day$MThinning_Leaf_Tree[i]+S$Table_Day$MThinning_Branch_Tree[i]+
        S$Table_Day$MThinning_CoarseRoot_Tree[i]+S$Table_Day$MThinning_Stem_Tree[i]+
        S$Table_Day$MThinning_FineRoot_Tree[i]

    # NPPtot_Tree
    S$Table_Day$NPPtot_Tree[i]=
        S$Table_Day$NPP_Stem_Tree[i]+S$Table_Day$NPP_Branch_Tree[i]+
        S$Table_Day$NPP_Leaf_Tree[i]+S$Table_Day$NPP_CoarseRoot_Tree[i]+
        S$Table_Day$NPP_FineRoot_Tree[i]+S$Table_Day$NPP_Reserves_Tree[i]

    # Daily C balance that should be nil every day:
    S$Table_Day$Cbalance_Tree[i]=
        S$Table_Day$OfferFunction_Tree[i]-(S$Table_Day$NPPtot_Tree[i]+S$Table_Day$Rc_Tree[i])

    S$Table_Day$LAI_Tree[i]= S$Table_Day$DM_Leaf_Tree[i]*(S$Parameters$SLA_Tree/1000)
    # Allometries ------------------------------------------------------------
    S$Parameters$Allometries(S,i)

    # Update LAI m2leaf m-2soil, caution, CM is in gC m-2soil, so use C content for DM
    # S$Table_Day$LAI_Tree[i]=
    #     S$Table_Day$CM_Leaf_Tree[i]*(S$Parameters$SLA_Tree/1000)/S$Parameters$CContent_Tree
    # S$Table_Day$LAI_Tree[i]= S$Table_Day$LAI_FGM_Tree[i]
...
write.results= function(FinalList,output=".RData",Simulation_Name= NULL,...){
    if(is.null(Simulation_Name)){
        Simulation_Name= gsub(" ","_",paste(FinalList$Location,FinalList$Parameters$Species_ID,
    ...
    if(output!=".RData"){
    write.table(FinalList$Table_Day,
    ...
    write.table(FinalList$PerCohortFruitDemand,
                paste0("3-Results/",Simulation_Name,"/PerCohortFruitDemand", "_",
                       format(FinalList$Met_c$Date[1], '%m-%Y'), "_",
                       format(tail(FinalList$Met_c$Date,1), '%m-%Y'),".csv"),
                sep=";",row.names = F, col.names = TRUE, ...)
    write.table(FinalList$Met_c,
...
check_C_balance= function(S){
    ...
    Table_balance=
        ...
        summarise(
            C_Offer= sum(GPP),
            Exports_Mortality=
                sum(Mact_RsWood+Mact_StumpCoarseRoot+
                        Mact_Leaf+Mact_FineRoot+Overriped_Fruit)+
                sum(Harvest_Fruit,na.rm = T)+sum(Carbon_Lack_Mortality),
            C_Delta= tail(CM_RsWood+CM_StumpCoarseRoot+CM_Leaf+CM_FineRoot+CM_RE+CM_Fruit,1)-
                head(CM_RsWood+CM_StumpCoarseRoot+CM_Leaf+CM_FineRoot+CM_RE+CM_Fruit,1),
...
#'              using the maximum and minimum daily temperature.
#'
#' @aliases degree_days_hourly
#'
...
#' The round argument is provided for conveniance, as growing temperatures less than 3 digits are likely to be
#' in the measurement error, and will probably have no visible effect on plant phenology.
#'
...
#'
#' @export
GDD= function(Tmax,Tmin,MinTT=5,MaxTT=NULL,Round=T){
    # Function to compute degree days at daily time-step
...
Import_Aquiares_data= function(S=NULL){
    ...
    Aquiares_df%<>%
        ...
        summarise(
            ...
            # Water:
            PPT= sum(PPT),
            # ETR_mm= sum(Convert.Var(LE_GF,"mmol.m-2.s-1_To_mm.semihour")),
