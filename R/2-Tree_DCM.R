...
Shade.Tree= function(S,i){
  ...
  S$Sim$Alloc_Branch_Tree[i]=
    S$Parameters$lambda_BranchWood_Tree*S$Sim$Offer_Total_Tree[i]
  #NPP
  ...
  S$Sim$Alloc_Leaf_Tree[i]=
    min(S$Parameters$Demand_Leaf_Tree*S$Sim$Stocking_Tree[i],
  ...
  S$Sim$CM_Leaf_Tree[i]=
    S$Sim$CM_Leaf_Tree[previous_i(i,1)]+S$Sim$NPP_Leaf_Tree[i]-
    S$Sim$Mact_Leaf_Tree[i]-S$Sim$MThinning_Leaf_Tree[i]

  S$Sim$CM_Branch_Tree[i]=
    S$Sim$CM_Branch_Tree[previous_i(i,1)]+S$Sim$NPP_Branch_Tree[i]-
    S$Sim$Mact_Branch_Tree[i]-S$Sim$MThinning_Branch_Tree[i]

  S$Sim$CM_Stem_Tree[i]=
    S$Sim$CM_Stem_Tree[previous_i(i,1)]+S$Sim$NPP_Stem_Tree[i]-
    S$Sim$Mact_Stem_Tree[i]-S$Sim$MThinning_Stem_Tree[i]

  S$Sim$CM_CR_Tree[i]=
    S$Sim$CM_CR_Tree[previous_i(i,1)]+
    S$Sim$NPP_CR_Tree[i]- S$Sim$Mact_CR_Tree[i]-
    S$Sim$MThinning_CR_Tree[i]

  S$Sim$CM_FRoot_Tree[i]=
    S$Sim$CM_FRoot_Tree[previous_i(i,1)]+
    S$Sim$NPP_FRoot_Tree[i]-S$Sim$Mact_FRoot_Tree[i]-
    S$Sim$MThinning_FRoot_Tree[i]

  S$Sim$CM_RE_Tree[i]=
    S$Sim$CM_RE_Tree[previous_i(i,1)]+
    S$Sim$NPP_Reserves_Tree[i]-S$Sim$Consumption_RE_Tree[i]
